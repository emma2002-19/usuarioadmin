...
<link href="https://fonts.googleapis.com/css2?family=Comfortaa:wght@300;400;500;600&family=PT+Serif:ital,wght@1,700&family=Source+Sans+Pro:ital,wght@0,400;1,300&family=Trispace&display=swap" rel="stylesheet">
...
font-family: 'Trispace', sans-serif;
	...
	<body style="background-image: url(https://thumbs.dreamstime.com/b/esferas-de-color-rosa-se-colocan-sobre-fondo-suave-colores-pastel-sombras-suaves-dise%C3%B1o-abstracto-y-moderno-d-render-210655034.jpg); ">
    ...
    <div class="row justify-content-center">
        <div class="col-md-7">
            ...
            <div class="card" style="background-color: #B2B2B2">
                ...
                <a href ="registro.php" class="boton2">Nuevo Rol</a>
			</center>
